            ...
            <div class="card">
                <div class="card-header">
                    <div class=" d-flex justify-content-between">
                        <div>
                            <h3>UserTypes List</h3>
                        </div>
                        <div class="">
                            <a class=" btn btn-primary" href={{ route('usertypes.create') }}>Add UserType</a>
                        </div>
                    </div>
                    ...
                    <table id="myTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            @foreach ($usertypes as $usertype)
                                ...
                                <tr>
                                    <td>{{ $sr }}</td>
                                    <td class="text-center">{{ $usertype->usertype }}</td>
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <button type="button"
                                                    ...
                                                    id="del_role" data-value="{{ $usertype->id }}" data-toggle="modal"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Delete UserType</h5>
                                                        ...
                                                        <div class="modal-footer py-1">
                                                            ...
                                                            <form class="redirect3" method="post">
                                                                @csrf
                                                                @method('delete')
                                                                <button type="submit"
