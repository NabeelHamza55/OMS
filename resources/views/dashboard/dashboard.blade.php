 @extends('dashboard.sidebar') @section('dashboard', 'active') @section('main_content')
 {{-- {{ dd(session('login')->usertype_id) }} --}}
 <div class="content-body">
     <!-- Content -->
     <div class="content ">
         <div class="page-header d-md-flex justify-content-between">
             <div>
                 <h3>Welcome back, {{ session('login')->first_name }}</h3>
                     ...
                     <div class="col-md-6">
                         <div class="card">
                             <div class="card-body">
                                 ...
                                 <p class="mb-0"><a href="#" class="link-1">See comments</a> and
                                     respond to customers' comments.</p>
                             </div>
                         </div>
                     </div>
                     <div class="col-md-6">
                         <div class="card">
                             <div class="card-body">
                                 ...
                                 <p class="mb-0"><a class="link-1" href="#">See visits</a> that had a
                                     higher than expected bounce rate.</p>
                             </div>
                         </div>
                     </div>
                     <div class="col-md-6">
                         <div class="card">
                             <div class="card-body">
                                 ...
                                 <p class="mb-0"><a class="link-1" href="#">See referring</a> domains
                                     that sent most visits last month.</p>
                             </div>
                         </div>
                     </div>
                     <div class="col-md-6">
                         <div class="card">
                             <div class="card-body">
                                 ...
                                 <p class="mb-0"><a class="link-1" href="#">See clients</a> that
                         ...
                         <div class="card-scroll" style="height: 430px">
                             <ul class="list-group list-group-flush">
                                 <li class="list-group-item d-flex px-0 py-4">
                                     <a href="#" class="flex-shrink-0">
                                         <figure class="avatar mr-3">
                                             <img src="{{ asset('custom/admin/assets/media//image/user/man_avatar1.jpg') }}"
                                 ...
                                 <li class="list-group-item d-flex px-0 py-4">
                                     <a href="#" class="flex-shrink-0">
                                         <figure class="avatar mr-3">
                                             <img src="{{ asset('custom/admin/assets/media//image/user/man_avatar2.jpg') }}"
                                                 class="rounded-circle" alt="image">
                                         </figure>
                                     </a>
                                     <div class="flex-grow-1">
                                 ...
                                 <li class="list-group-item d-flex px-0 py-4">
                                     <a href="#" class="flex-shrink-0">
                                         <figure class="avatar mr-3">
                                             <img src="{{ asset('custom/admin/assets/media//image/user/man_avatar4.jpg') }}"
                                                 class="rounded-circle" alt="image">
                                         </figure>
                                     </a>
                                     <div class="flex-grow-1">
                 ...
                 <div class="card">
                     <div class="card-body">
                         <div class="text-center">
                             ...
                             <p>This chart shows total sales. You can use the button below for details of this month's
                                 sales.</p>
                             <div class="mt-4">
                         ...
                         <tbody>
                             <tr>
                                 <td>
                                     <a href="product-detail.html" class="d-flex align-items-center">
                                         <img width="40"
                                             src="{{ asset('custom/admin/assets/media//image/products/product1.png') }}"
                             ...
                             <tr>
                                 <td>
                                     <a href="product-detail.html" class="d-flex align-items-center">
                                         <img width="40"
                                             src="{{ asset('custom/admin/assets/media//image/products/product2.png') }}"
                             ...
                             <tr>
                                 <td>
                                     <a href="product-detail.html" class="d-flex align-items-center">
                                         <img width="40"
                                             src="{{ asset('custom/admin/assets/media//image/products/product3.png') }}"
                             ...
                             <tr>
                                 <td>
                                     <a href="product-detail.html" class="d-flex align-items-center">
                                         <img width="40"
                                             src="{{ asset('custom/admin/assets/media//image/products/product4.png') }}"
                             ...
                             <tr>
                                 <td>
                                     <a href="product-detail.html" class="d-flex align-items-center">
                                         <img width="40"
                                             src="{{ asset('custom/admin/assets/media//image/products/product5.png') }}"
                             ...
                             <tr>
                                 <td>
                                     <a href="product-detail.html" class="d-flex align-items-center">
                                         <img width="40"
                                             src="{{ asset('custom/admin/assets/media//image/products/product6.png') }}"
                             ...
                             <tr>
                                 <td>
                                     <a href="product-detail.html" class="d-flex align-items-center">
                                         <img width="40"
                                             src="{{ asset('custom/admin/assets/media//image/products/product7.png') }}"
                             ...
                             <tr>
                                 <td>
                                     <a href="product-detail.html" class="d-flex align-items-center">
                                         <img width="40"
                                             src="{{ asset('custom/admin/assets/media//image/products/product8.png') }}"
                             ...
                             <tr>
                                 <td>
                                     <a href="product-detail.html" class="d-flex align-items-center">
                                         <img width="40"
                                             src="{{ asset('custom/admin/assets/media//image/products/product9.png') }}"
                             ...
                             <tr>
                                 <td>
                                     <a href="product-detail.html" class="d-flex align-items-center">
                                         <img width="40"
                                             src="{{ asset('custom/admin/assets/media//image/products/product10.png') }}"
